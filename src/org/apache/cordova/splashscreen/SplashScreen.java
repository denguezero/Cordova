...
import br.com.denguezerocidadao.R;
...
public class SplashScreen extends CordovaPlugin {
    ...
    protected void pluginInitialize() {
        ...
        if (drawableId == 0) {
            ...
            //int[] yourListOfImages= {R.drawable.screen};

            //Random random = new Random(System.currentTimeMillis());
            //int posOfImage = random.nextInt(yourListOfImages.length - 1);
            String splashResource = preferences.getString("SplashScreen", String.valueOf(R.drawable.screen));
    ...
    private void showSplashScreen(final boolean hideAfterDelay) {
        final int splashscreenTime = preferences.getInteger("SplashScreenDelay", 5000);
